...
FOLDER = "/media/lscsc/nas/xianping/ISPRS_dataset/loveDA/" # Replace with your "/path/to/the/ISPRS/dataset/folder/"
...
def train(epochs, weights=WEIGHTS, save_epoch=2):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % 1 == 0:
            ...
            start_time = time.time()
            if MIoU > MIoU_best:
                torch.save(model.state_dict(), './Train_Model/UNetFormer_R2U_epoch{}_{}'.format(epoch, MIoU))
                MIoU_best = MIoU
    print("Train Done!!")
